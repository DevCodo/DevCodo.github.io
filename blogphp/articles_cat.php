                ...
                <?php
                  if($articles_exist == true) {
                    if($total_pages == 1) {
                      ...
                      if($page > 1) {
                        echo '<a href="/articles_cat.php?page='.($page - 1).'&categorie='.$categorie_id.'">&lt; Предыдущая стралница &nbsp;</a>';

                      }
                      if($page < $total_pages) {
                        echo '<a href="/articles_cat.php?page='.($page + 1).'&categorie='.$categorie_id.'"> Следующая стралница &gt;</a>';
                      }
                      echo '</div>';
                    }
