      ...
      <div class="container">
        <div class="row">
          <section class="content__left col-md-8">
                        ...
                        <article class="article">
                          ...
                          <div class="article__info">
                            ...
                            <div class="article__info__meta">
                              ...
                              <small>Категория: <a href="/articles_cat.php?categorie=<?php echo $art_cat['id'] ?>"><?php echo $art_cat['title'] ?></a></small>
                            </div>
            ...
            <div class="block">
              <a href="/articles_cat.php?categorie=1">Все записи</a>
            ...
            <div class="block">
              <a href="/articles_cat.php?categorie=2">Все записи</a>
            ...
            <div class="block">
              <a href="/articles_cat.php?categorie=3">Все записи</a>
              <h3>Авто [Новейшее]</h3>
              <div class="block__content">
                <div class="articles articles__horizontal">
            ...
            <div class="block">
              <a href="/articles_cat.php?categorie=4">Все записи</a>
              <h3>Технологии [Новейшее]</h3>
              <div class="block__content">
                <div class="articles articles__horizontal">
            ...
            <div class="block">
              <a href="/articles_cat.php?categorie=5">Все записи</a>
              <h3>Игры [Новейшее]</h3>
              <div class="block__content">
                <div class="articles articles__horizontal">
            ...
            <div class="block">
              <a href="/articles_cat.php?categorie=6">Все записи</a>
              <h3>Бизнес [Новейшее]</h3>
              <div class="block__content">
                <div class="articles articles__horizontal">
            ...
            <div class="block">
              <a href="/articles_cat.php?categorie=7">Все записи</a>
              <h3>Стиль жизни [Новейшее]</h3>
              <div class="block__content">
                <div class="articles articles__horizontal">
